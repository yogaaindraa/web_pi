		...
		<div id="wrapper" class="container">
			<section class="navbar main-menu">
				<div class="navbar-inner main-menu">				
					<a href="" class="logo pull-left"><img src="../themes/images/DINUSMARKET.png" class="site_logo" alt=""></a>
					...
					<div class="span5">
						<div>
							...
							<p><strong>Phone:</strong> 085-727-426-188<br>
							  ...
							  <strong>Email:</strong>&nbsp;dewiastria95@gmail.com</p>
							Atau 
							<p><strong>Phone:</strong>&nbsp;087-834-655-015<br>
							<strong>Fax:</strong>&nbsp;+04 (113) 023-1145<br>
							<strong>Email:</strong>&nbsp;<a href="#">Azizatul12@gmail.com</a>					
							</p>
						</div>
					</div>
				<fieldset>
...
<table width="387" border="0">
  <tr>
    <td width="75">&nbsp;</td>
    <td width="252">&nbsp;</td>
    <td width="38"><a href="del-guestbook.php?id=<?php echo "$arraytampil[0]";?>">delete </a></td>
  </tr>
  <tr>
    <td>nama</td>
